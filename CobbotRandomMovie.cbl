      ...
      *    01 MovieType            PIC 9.
           ...
           01 MoviePath         PIC X(80).
           01 PrnComment         PIC X(60).
      *    01 MovieType            PIC 9.
           
           PROCEDURE DIVISION USING MainSeed, *>MovieType, 
                                       MovieRand, 
                                       MoviePath, PrnComment.
           
           MOVE FUNCTION CURRENT-DATE TO RandomGen
           DISPLAY "Path: " MoviePath
      *    COMPUTE MovieType = FUNCTION RANDOM * 
      *                        ((Mainseed - 1) * 13) + 1
           Add 1 TO seed
      *    DISPLAY "Movie Type: " Movietype
           INSPECT FUNCTION REVERSE(RandomMovie(MovieRand)) 
                                  TALLYING CharCount FOR LEADING SPACES
           COMPUTE StrgSize = (60 - CharCount)
           STRING RandomMovie(MovieRand)(1 : Strgsize)
               INTO MoviePath
           END-STRING
           
           DISPLAY "Rand Path: " MoviePath
           DISPLAY "Comment: " Comment(MovieRand)
           MOVE Comment(MovieRand) TO PrnComment.


           END PROGRAM CobbotRandomMovie.
